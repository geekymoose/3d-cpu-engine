...
TEST_F(VectF4Test, constructors) {
    ...
    ASSERT_VECTF4_VALUES_EQ(vec2, -32, 89, -4.2, 8.232);
}
...
TEST_F(VectF4Test, normalizeFast) {
    v1.normalizeFast();
    v2.normalizeFast();
    v3.normalizeFast();
    ASSERT_VECTF4_VALUES_EQ(v1, 0.1825742, 0.3651484, 0.5477226, 0.7302967);
    ASSERT_VECTF4_VALUES_EQ(v2, 0.4591311, 0.2921744, -0.0834784, 0.8347839);
    ASSERT_VECTF4_VALUES_EQ(v3, -0.9258466, 0.1944278, -0.1944278, -0.259237);
}
...
TEST_F(VectF4Test, crossProduct) {
    // v1
    ASSERT_VECTF4_VALUES_EQ(VectF4::crossProduct(v1, v1), 0,0,0,0);
    ASSERT_VECTF4_VALUES_EQ(VectF4::crossProduct(v1,v2), -12.5, 17.5, -7.5, 0);
    ASSERT_VECTF4_VALUES_EQ(VectF4::crossProduct(v1,v3), -10.5, -27.9, 22.1, 0);
    // v2
    ASSERT_VECTF4_VALUES_EQ(VectF4::crossProduct(v2,v1), 12.5, -17.5, 7.5, 0);
    ASSERT_VECTF4_VALUES_EQ(VectF4::crossProduct(v2,v2), 0,0,0,0);
    ASSERT_VECTF4_VALUES_EQ(VectF4::crossProduct(v2,v3), -5.25, 21.55, 46.55, 0);
    // v3
    ASSERT_VECTF4_VALUES_EQ(VectF4::crossProduct(v3,v1), 10.5, 27.9, -22.1, 0);
    ASSERT_VECTF4_VALUES_EQ(VectF4::crossProduct(v3,v2), 5.25, -21.55, -46.55, 0);
    ASSERT_VECTF4_VALUES_EQ(VectF4::crossProduct(v3,v3), 0,0,0,0);
}
...
TEST_F(VectF4Test, multiply_scalar) {
    ...
    // v1
    ASSERT_VECTF4_VALUES_EQ((v1 * s1), 13.3, 26.6, 39.9, 53.2);
    ASSERT_VECTF4_VALUES_EQ((v1 * s2), -9.2, -18.4, -27.6, -36.8);
    ASSERT_VECTF4_VALUES_EQ((v1 * s3), 4.9, 9.8, 14.7, 19.6);
    // v2
    ASSERT_VECTF4_VALUES_EQ((v2 * s1), 73.15, 46.55, -13.3, 133.0);
    ASSERT_VECTF4_VALUES_EQ((v2 * s2), -50.6, -32.2, 9.2, -92.0);
    ASSERT_VECTF4_VALUES_EQ((v2 * s3), 26.95, 17.15, -4.9, 49.0);
    // v3
    ASSERT_VECTF4_VALUES_EQ((v3 * s1), -133.0, 27.93, -27.93, -37.24);
    ASSERT_VECTF4_VALUES_EQ((v3 * s2), 92.0, -19.32, 19.32, 25.76);
    ASSERT_VECTF4_VALUES_EQ((v3 * s3), -49.0, 10.29, -10.29, -13.72);
}

TEST_F(VectF4Test, multiply_vector) {
    ASSERT_VECTF4_VALUES_EQ((v1 * v1), 1, 4, 9, 16);
    ASSERT_VECTF4_VALUES_EQ((v1 * v2), 5.5, 7, -3, 40);
}
...
TEST_F(VectF4Test, divide_vector) {
    ASSERT_VECTF4_VALUES_EQ((v0 / v2), 0, 0, 0, 0);
    ASSERT_VECTF4_VALUES_EQ((v1 / v1), 1, 1, 1, 1);
}

TEST_F(VectF4Test, add_scalar) {
    ASSERT_VECTF4_VALUES_EQ((v0 + 10), 10, 10, 10, 10);
    ASSERT_VECTF4_VALUES_EQ((v1 + 3.9), 4.9, 5.9, 6.9, 7.9);
    ASSERT_VECTF4_EQ((v3 + 0), v3);
}

TEST_F(VectF4Test, add_vector) {
    // v1
...
TEST_F(VectF4Test, substract_scalar) {
    ASSERT_VECTF4_VALUES_EQ((v0 - 10), -10, -10, -10, -10);
    ASSERT_VECTF4_VALUES_EQ((v2 - 2.5), 3, 1, -3.5, 7.5);
    ASSERT_VECTF4_EQ((v3 - 0), v3);
}
...
TEST_F(VectF4Test, multiply_vector_inplace) {
    v0 *= v3;
    v1 *= v2;
    ASSERT_VECTF4_VALUES_EQ(v0, 0, 0, 0, 0);
    ASSERT_VECTF4_VALUES_EQ(v1, 5.5, 7, -3, 40);
}
...
TEST_F(VectF4Test, divide_vector_inplace) {
    v0 /= v3;
    v1 /= v1;
    ASSERT_VECTF4_VALUES_EQ(v0, 0, 0, 0, 0);
    ASSERT_VECTF4_VALUES_EQ(v1, 1, 1, 1, 1);
}

TEST_F(VectF4Test, add_scalar_inplace) {
    v0 += 2.4;
    v2 += 0;
    ASSERT_VECTF4_VALUES_EQ(v0, 2.4, 2.4, 2.4, 2.4);
    ASSERT_VECTF4_VALUES_EQ(v2, 5.5, 3.5, -1, 10);
}
...
TEST_F(VectF4Test, subtract_scalar_inplace) {
    v0 -= -922.32;
    v1 -= v1;
    v3 -= 0;
    ASSERT_VECTF4_VALUES_EQ(v0, 922.32, 922.32, 922.32, 922.32);
    ASSERT_VECTF4_VALUES_EQ(v1, 0, 0, 0, 0);
    ASSERT_VECTF4_VALUES_EQ(v3, -10, 2.1, -2.1, -2.8);
}
